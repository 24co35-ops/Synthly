  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-[480px] bg-[var(--color-surface)] rounded-2xl shadow-2xl overflow-hidden animate-slide-up">
        ...
        <div className="p-6 space-y-8">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${privacyMode ? 'bg-teal-500' : 'bg-gray-200 dark:bg-gray-700'}`}
            >
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full p-2.5 bg-[var(--color-bg)] border border-[var(--color-border)] rounded-lg text-[14px] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
            >
        ...
        <div className="p-6 bg-[var(--color-bg)] flex justify-end gap-3">
          <button onClick={toggleSettings} className="px-4 py-2 text-[14px] font-medium text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg">
            Cancel
          </button>
          <button onClick={toggleSettings} className="px-4 py-2 text-[14px] font-medium bg-[var(--color-primary)] text-white hover:bg-[var(--color-primary-hover)] rounded-lg">
            Save Settings
          </button>
        </div>
      </div>
